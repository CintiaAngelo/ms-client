...
public class ClienteController {
    ...
    public ResponseEntity<ScoreCreditoResponseDTO> calcularScoreCredito(@PathVariable Long id) {
        return ResponseEntity.ok(clienteService.calcularScoreCredito(id));
    }
}